...
crosssec_df_cca <-  analytic_df %>% 
  ...
  dplyr::filter(if_all(contains("mnsi"), ~ !is.na(.)))

saveRDS(crosssec_df_cca,paste0(path_diabetes_subphenotypes_youth_folder,"/working/cleaned/etiologic/complete cases/cca01_cross sectional complete cases df.RDS"))
