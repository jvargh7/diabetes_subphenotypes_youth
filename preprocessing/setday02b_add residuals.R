...
analytic_df = read_csv(paste0(path_diabetes_subphenotypes_youth_folder, '/working/cleaned/setdy02_kmeans imputation.csv'))
...
write.csv(analytic_dataset, paste0(path_diabetes_subphenotypes_youth_folder,"/working/cleaned/setdy02b_kmeans imputation add residuals.csv"))
