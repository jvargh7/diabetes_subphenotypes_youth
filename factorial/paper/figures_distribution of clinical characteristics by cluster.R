...
ggarrange(fig_A,
  ...
  ggsave(.,filename=paste0(path_diabetes_subphenotypes_youth_folder,"/figures/factorial/distribution of clinicalcharacteristics by cluster.jpg"),width=12,height =5.5)
