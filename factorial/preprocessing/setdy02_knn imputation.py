...
data_mi = pd.read_csv(path_diabetes_subphenotypes_youth_folder + '/working/cleaned/factorial/setdy01a_analytic sample.csv')
...
selected_variables = ["study_id","study","age_category","dmduration_category","race_eth",
                      ...
                      "sbp","dbp","totalc","ldlc","hdlc","insulin","metformin","bmipct",
...
imputed_data_merged.to_csv(path_diabetes_subphenotypes_youth_folder + '/working/cleaned/factorial/setdy02_knn imputation.csv', index=False)
