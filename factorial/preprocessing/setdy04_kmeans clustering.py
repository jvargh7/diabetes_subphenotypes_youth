...
analytic_dataset = pd.read_csv(path_diabetes_subphenotypes_youth_folder + '/working/cleaned/factorial/setdy03_knn imputation add residuals.csv') 
...
analytic_dataset_cluster['cluster'] = analytic_dataset_cluster['cluster'].replace({0:'yOD', 1:'yIDD', 2:'yIRD'})
...
analytic_dataset_cluster['cluster'].value_counts()
analytic_dataset_cluster.to_csv(path_diabetes_subphenotypes_youth_folder + '/working/cleaned/factorial/setdy04_kmeans clustering.csv', index=False)
...
# relabel the cluster labels
data_scaled_cluster['cluster'] = data_scaled_cluster['cluster'].replace({0:'yOD', 1:'yIDD', 2:'yIRD'})
