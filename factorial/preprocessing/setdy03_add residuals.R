...
analytic_df = read_csv(paste0(path_diabetes_subphenotypes_youth_folder, '/working/cleaned/factorial/setdy02_knn imputation.csv'))
...
write.csv(analytic_dataset, paste0(path_diabetes_subphenotypes_youth_folder,"/working/cleaned/factorial/setdy03_knn imputation add residuals.csv"))
...
bind_rows(
  ...
  write_csv(.,"factorial/preprocessing/setdy03_age category coefficients.csv")
