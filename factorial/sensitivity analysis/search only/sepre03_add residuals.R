...
analytic_df = read_csv(paste0(path_diabetes_subphenotypes_youth_folder, '/working/cleaned/factorial/search only/sepre02_knn imputation.csv'))
...
write.csv(analytic_dataset, paste0(path_diabetes_subphenotypes_youth_folder,"/working/cleaned/factorial/search only/sepre03_knn imputation add residuals.csv"))
