...
analytic_df <- read.csv(paste0(path_diabetes_subphenotypes_youth_folder, '/working/cleaned/factorial/search only/sepre04_kmeans clustering.csv')) 
...
saveRDS(crosssec_df,paste0(path_diabetes_subphenotypes_youth_folder,"/working/cleaned/factorial/search only/se01_cross sectional df.RDS"))
