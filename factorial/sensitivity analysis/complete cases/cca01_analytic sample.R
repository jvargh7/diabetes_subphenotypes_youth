...
saveRDS(crosssec_df_cca,paste0(path_diabetes_subphenotypes_youth_folder,"/working/cleaned/factorial/complete cases/cca01_cross sectional complete cases df.RDS"))
