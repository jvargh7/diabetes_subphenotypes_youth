...
crosssec_df_cca <- readRDS(paste0(path_diabetes_subphenotypes_youth_folder,"/working/cleaned/factorial/complete cases/cca01_cross sectional complete cases df.RDS")) %>% 
...
bind_rows(
  ...
  write_csv(.,"factorial/sensitivity analysis/complete cases/cca02_cross-sectional coefficients.csv")
