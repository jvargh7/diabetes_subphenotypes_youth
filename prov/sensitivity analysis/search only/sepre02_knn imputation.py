...
data_mi = pd.read_csv(path_diabetes_subphenotypes_youth_folder + '/working/cleaned/prov/search only/sepre01_analytic sample.csv')
...
imputed_data_merged.to_csv(path_diabetes_subphenotypes_youth_folder + '/working/cleaned/prov/search only/sepre02_knn imputation.csv', index=False)
