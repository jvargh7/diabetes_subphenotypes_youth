...
analytic_dataset = pd.read_csv(path_diabetes_subphenotypes_youth_folder + '/working/cleaned/prov/search only/sepre03_knn imputation add residuals.csv') 
...
analytic_dataset_cluster['cluster'] = analytic_dataset_cluster['cluster'].replace({0:'ySIRD', 1:'ySIDD', 2:'yMOD'})
...
analytic_dataset_cluster['cluster'].value_counts()
analytic_dataset_cluster.to_csv(path_diabetes_subphenotypes_youth_folder + '/working/cleaned/prov/search only/sepre04_kmeans clustering.csv', index=False)
...
# relabel the cluster labels
data_scaled_cluster['cluster'] = data_scaled_cluster['cluster'].replace({0:'ySIRD', 1:'ySIDD', 2:'yMOD'})
