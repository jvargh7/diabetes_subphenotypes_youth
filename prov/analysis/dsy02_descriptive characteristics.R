...
source_df <- read.csv(paste0(path_diabetes_subphenotypes_youth_folder,"/working/cleaned/prov/setdy01c_source sample.csv"))
...
write_csv(table_df,"prov/analysis/dsy02_descriptive characteristics - total by cluster.csv")
...
write_csv(table_df,"prov/analysis/dsy02_descriptive characteristics - total by study and cca.csv")
...
write_csv(table_df,"prov/analysis/dsy02_descriptive characteristics - total by study and sex.csv")
...
write_csv(table_df,"prov/analysis/dsy02_descriptive characteristics - total by sex and cluster.csv")
...
write_csv(table_df,"prov/analysis/dsy02_descriptive characteristics - total by study.csv")
