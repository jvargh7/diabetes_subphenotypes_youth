...
imputed_data <- read.csv(paste0(path_diabetes_subphenotypes_youth_folder, '/working/cleaned/prov/setdy02_knn imputation.csv')) %>% 
...
ggsave(elbow_plot,filename=paste0(path_diabetes_subphenotypes_youth_folder,"/figures/prov/elbow plot for optimal number of clusters.png"),width=6, height = 4)
