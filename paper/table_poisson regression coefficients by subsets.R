...
datasets <- list(
  etiologic_main = "etiologic/paper/table_cross-sectional poisson regression coefficients main clusters.csv",
  ...
  factorial_main = "factorial/paper/table_cross-sectional poisson regression coefficients main clusters.csv",
  ...
  prov_main = "prov/paper/table_cross-sectional poisson regression coefficients main clusters.csv",
...
write_csv(combined_tab,"paper/table_cross-sectional poisson regression coefficients by subsets.csv")